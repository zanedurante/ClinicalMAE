...
def get_args():
    ...
    # Dataset parameters
    parser.add_argument(
        "--data_path", default="/your/data/path/", type=str, help="dataset path"
    )
    ...
    parser.add_argument(
        "--start_idx", default=1, type=int, help="start_idx for rwaframe dataset"
    )
    ...
    if args.finetune:
        ...
        for k in ["head.weight", "head.bias"]:
            if (
                ...
                if checkpoint_model[k].shape[0] == 710 and args.data_set.startswith(
                    "Kinetics"
                ):
